...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Article_1.Article, article => article.comment, { onUpdate: "CASCADE", onDelete: "CASCADE" }),
    __metadata("design:type", Article_1.Article)
], Comment.prototype, "article", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, user => user.comment, { onUpdate: "CASCADE", onDelete: "CASCADE" }),
...
], Comment.prototype, "beforeInsertion", null);
Comment = __decorate([
